...
const testimonials = [
  {
    ...
    description: "Absolutely love my crochet tray table! The craftsmanship is incredible and it adds such a beautiful touch to my living room. Will definitely be ordering more!",
    image: "https://i.pravatar.cc/150?u=1",
  },
  {
    id: "2",
    title: "Jennifer Adams",
    description: "The quality exceeded my expectations. The attention to detail is amazing, and you can really feel the love and care that went into making this. Highly recommend!",
    image: "https://i.pravatar.cc/150?u=2",
  },
  {
    id: "3",
    title: "Emily Rodriguez",
    description: "Perfect addition to my home! The customization options are fantastic, and the final product looks even better than the pictures. Outstanding service!",
    image: "https://i.pravatar.cc/150?u=3",
  },
  {
    id: "4",
    title: "Amanda Foster",
    description: "I've been a customer for 2 years now and every piece I've ordered has been perfect. The quality is consistent and the designs are unique!",
    image: "https://i.pravatar.cc/150?u=4",
  },
  {
    id: "5",
    title: "Jessica Chen",
    description: "The best handmade crochet products I've ever purchased! The colors are vibrant and the material is high quality. Worth every penny!",
